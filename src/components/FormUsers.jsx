...
const FormUsers = ({createNewUser, updateInfo, updateUserById, setUpdateInfo, setFormIsClose}) => {
    ...
    return (
        <form className='form' onSubmit={handleSubmit(submit)}>
            <i  onClick={handleCloseForm} className="form__x fa-sharp fa-solid fa-circle-xmark"></i>
            ...
            <div className='form__div'>
                ...
                <input className='form__input' placeholder='Enter your name' type="text" id= 'first_name' {...register('first_name')}/>
            </div>
            <div className='form__div'>
                <label htmlFor="last_name">Last Name: </label>
                <input className='form__input' placeholder='Enter your las name' type="text" id= 'last_name' {...register('last_name')}/>
            </div>
            <div className='form__div'>
